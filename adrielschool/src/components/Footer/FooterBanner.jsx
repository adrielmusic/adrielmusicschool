...
const FooterBanner = () => {
  return (
    <section className="relative z-10 overflow-hidden bg-indigo-600 dark:bg-gray-700 py-16 px-8">
                ...
                <div className="text-center lg:text-left ">
                    <div className="mb-10 lg:mb-0 ">
                        <h1
                            ...
                            Start Learning your favourite Music Instruments Today</h1>
                        <p
